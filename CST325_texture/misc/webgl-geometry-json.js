...
function WebGLGeometryJSON(gl) {
	...
	this.create = function(jsonFileData, rawImage) {
        ...
        if (rawImage) {
            ...
            // 2. todo bind the texture - Done
            this.gl.bindTexture(gl.TEXTURE_2D, this.texture);

            // needed for the way browsers load images, ignore this
            this.gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true);

            // 3. todo set wrap modes (for s and t) for the texture - Done
            ...
            // 4. todo set filtering modes (magnification and minification) - Done
            this.gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
            this.gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);

            // 5. send the image WebGL to use as this texture - Done
            // book shows gl.RGB, Mozilla shows gl.RGBA may check after next step
